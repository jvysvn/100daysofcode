...
function fetchTopStocks() {
  // Fetch data from api
  fetch(
    'https://www.alphavantage.co/query?function=SECTOR&apikey=WD23PJ1BEC9ER6IJ'
  )
...
function fetchStockData(symbol) {
  ...
  fetch(
    `https:www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=${symbol}&apikey=WD23PJ1BEC9ER6IJ`
  )
    .then((response) => response.json())
    .then((data) => {
